...
namespace csharp_test_client
{
    public partial class mainForm
    {
        ...
        void PacketProcess_RoomEnterResponse(byte[] bodyData)
        {
            ...
            {
                AddRoomUserList(responsePkt.RoomUserUniqueId, textBoxUserID.Text);
            }
        ...
        void PacketProcess_RoomChatResponse(byte[] bodyData)
        {
            ...
            {
                DevLog.Write($"메세지 전송 성공");
                //AddRoomChatMessageList("result", msg);
            }
        }
        ...
        void AddRoomChatMessageList(Int64 userUniqueId, string message)
        {
            //            var msg = $"{userUniqueId}:  {msgssage}";
            // var if userId has null character, msg doesn't display message.
            string userId = GetRoomUserId(userUniqueId);
